    ...
    <section className={styles.about}>
      <div className={styles.aboutWrapper}>
        <article className={styles.textAbt}>
          ...
          <p>
            I love tinkering, even though I&apos;m probably not a full-time like a professional, i do it for fun. You can find me buried in open source code, fiddling with scripts and exploring ctfs in my spare time (~_^). Implementing reliable security systems is something I&apos;m committed to doing while looking chic.
          </p>
        </article>
